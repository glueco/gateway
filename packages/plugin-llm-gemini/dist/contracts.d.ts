...
declare const PLUGIN_ID: "llm:gemini";
declare const RESOURCE_TYPE: "llm";
declare const PROVIDER: "gemini";
declare const VERSION = "1.0.0";
/** Default allowed models */
declare const DEFAULT_GEMINI_MODELS: readonly ["gemini-3-pro", "gemini-3-flash", "gemini-2.5-pro", "gemini-2.5-flash", "gemini-2.5-flash-lite"];
/** Supported actions */
...
export { ACTIONS, type ChatCompletionChoice, ChatCompletionChoiceSchema, type ChatCompletionChunk, ChatCompletionChunkSchema, type ChatCompletionRequest, ChatCompletionRequestSchema, type ChatCompletionResponse, ChatCompletionResponseSchema, type ChatMessage, ChatMessageSchema, DEFAULT_GEMINI_MODELS, ENFORCEMENT_SUPPORT, type GeminiAction, PLUGIN_ID, PROVIDER, RESOURCE_TYPE, type Usage, UsageSchema, VERSION };
